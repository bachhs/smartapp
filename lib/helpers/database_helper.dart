...
class DatabaseHelper {
  ...
  // // Function using Task.toMap() to convert the _taskList to json data to post request
  // Future<String> postJSONData(List<Map<String, dynamic>> taskList) async {
